Public Class frmHost
        ...
        Select Case Menu
            Case "1"
                ...
                ElseIf txtClass.Text = "C" Then
                    ...
                    lblNA2.Text = txt1octet.Text + Val(lblIncrement.Text) & "." & txt2octet.Text & "." & txt3octet.Text & "." & "0"
                    lblNA3.Text = txt1octet.Text + Val(lblIncrement.Text) * 2 & "." & txt2octet.Text & "." & txt3octet.Text & "." & "0"
                    lblNA4.Text = txt1octet.Text + Val(lblIncrement.Text) * 3 & "." & txt2octet.Text & "." & txt3octet.Text & "." & "0"
                    lblNA5.Text = txt1octet.Text + Val(lblIncrement.Text) * 4 & "." & txt2octet.Text & "." & txt3octet.Text & "." & "0"

                    lblBA1.Text = txt1octet.Text + Val(lblIncrement.Text) - 1 & "." & txt2octet.Text & "." & txt3octet.Text & "." & "255"
                    lblBA2.Text = txt1octet.Text + Val(lblIncrement.Text) * 2 - 1 & "." & txt2octet.Text & "." & txt3octet.Text & "." & "255"
                    lblBA3.Text = txt1octet.Text + Val(lblIncrement.Text) * 3 - 1 & "." & txt2octet.Text & "." & txt3octet.Text & "." & "255"
                    lblBA4.Text = txt1octet.Text + Val(lblIncrement.Text) * 4 - 1 & "." & txt2octet.Text & "." & txt3octet.Text & "." & "255"
                    lblBA5.Text = txt1octet.Text + Val(lblIncrement.Text) * 5 - 1 & "." & txt2octet.Text & "." & txt3octet.Text & "." & "255"
    ...
    Private Sub txtNetwork_TextChanged(sender As Object, e As EventArgs) Handles txtNetwork.TextChanged
